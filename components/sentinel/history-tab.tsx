        ...
        {filtered.map((d) => (
          ...
          >
            ...
            <button
              ...
              className="size-12 shrink-0 overflow-hidden rounded-sm bg-gradient-to-br from-forest to-black ring-1 ring-border"
      ...
      {enlarged && (
        ...
        >
          <div className="relative max-w-md">
            ...
            <div className="flex aspect-video w-[28rem] max-w-full items-center justify-center rounded-md bg-gradient-to-br from-forest to-black text-7xl ring-1 ring-amber/30">
              🐻
            </div>
